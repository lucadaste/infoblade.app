// S&P 500 constituent tickers, used as the tracked universe for the price-
// snapshot collector (api/collect-price-snapshots.js) behind short-horizon
// stock move prediction — see the plan. Sourced from Wikipedia's maintained
// S&P 500 constituents table (generated 2026-09-17), symbols normalized to
// Yahoo Finance's dash convention for dual-class tickers (e.g. BRK.B -> BRK-B).
// Regenerate occasionally as index composition changes; a few stale/added
// tickers between regenerations doesn't meaningfully affect the collector.
export const SP500_TICKERS = [
  ...
  'BX', 'BXP', 'C', 'CAH', 'CARR', 'CASY', 'CAT', 'CB', 'CBRE', 'CCI',
  ...
  'EOG', 'EQIX', 'EQT', 'ERIE', 'ES', 'ESS', 'ETN', 'ETR', 'EVRG', 'EW',
  'EXC', 'EXE', 'EXPD', 'EXPE', 'EXR', 'F', 'FANG', 'FAST', 'FCX', 'FDS',
  'FDX', 'FDXF', 'FE', 'FERG', 'FFIV', 'FICO', 'FIS', 'FISV', 'FITB', 'FIX',
  'FLEX', 'FOX', 'FOXA', 'FRT', 'FSLR', 'FTNT', 'FTV', 'GD', 'GDDY', 'GE',
  ...
  'PYPL', 'Q', 'QCOM', 'RCL', 'RDDT', 'REG', 'REGN', 'RF', 'RJF', 'RL',
  ...
  'URI', 'USB', 'V', 'VEEV', 'VICI', 'VLO', 'VLTO', 'VMC', 'VMRK', 'VRSK',
